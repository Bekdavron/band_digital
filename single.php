      ...
      <main class="col-lg-8">
        <div class="row">
          ...
          while ( have_posts() ) :
            ...
            the_post_navigation(
              array(
                'prev_text' => '<span class="nav-subtitle">' . esc_html__( 'Previous:', 'webproger_theme' ) . '</span> <span class="nav-title">%title</span>',
                'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'webproger_theme' ) . '</span> <span class="nav-title">%title</span>',
              )
            );
